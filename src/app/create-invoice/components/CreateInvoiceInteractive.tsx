 ...
 *,
 ...
 <div>
 <h1 className="text-4xl font-bold text-foreground tracking-tight sm:text-5xl capitalize">
 ...
 <div className="bg-card border border-border rounded-md p-6 shadow-elevation-1">
 <h2 className="text-xl font-semibold text-foreground mb-4 capitalize">{documentType} Details</h2>
