...
const ReportFilters = ({ filters, onFilterChange }: ReportFiltersProps) => {
 ...
 <label className="text-[10px] font-bold text-muted-foreground font-medium ml-1">Period</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-muted-foreground font-medium ml-1">Report Category</label>
 <div className="relative group">
 <select
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-muted-foreground font-medium ml-1">Client Group</label>
 <div className="relative group">
 <select
