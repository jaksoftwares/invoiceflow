...
const ReportsAnalyticsInteractive = () => {
 ...
 <h1 className="text-4xl font-bold text-foreground tracking-tight sm:text-5xl mb-6">
 Reports & Analytics
 </h1>
 ...
 <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-bold">Revenue & Collection</p>
 </div>
 </button>
 ...
 <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-bold">Full Database List</p>
 </div>
 </button>
 ...
 <p className="text-[10px] text-muted-foreground uppercase tracking-wider font-bold">Services & Pricing</p>
 </div>
 </button>
 </div>
 </div>
