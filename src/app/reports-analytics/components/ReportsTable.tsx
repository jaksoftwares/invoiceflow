...
const ReportsTable = ({ data, currency = 'KES' }: ReportsTableProps) => {
 ...
 <span className="text-[10px] font-bold text-muted-foreground font-medium bg-muted px-2 py-1 rounded">
 ...
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium">Client</th>
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium">Invoices</th>
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium text-right">Revenue</th>
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium text-right">Avg Val</th>
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium">Payment Rate</th>
 <th className="px-8 py-4 text-[10px] font-bold text-muted-foreground font-medium text-right">Outstanding</th>
 </tr>
 </thead>
 ...
 <span className="text-[10px] font-bold text-muted-foreground font-medium mb-1">Total Gross</span>
 ...
 <div className="flex flex-col">
 <span className="text-[10px] font-bold text-muted-foreground font-medium mb-1">Total Outstanding</span>
