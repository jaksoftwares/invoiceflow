...
const InvoiceManagementInteractive = ({ initialInvoices }: InvoiceManagementInteractiveProps) => {
 ...
 className="w-full sm:w-auto bg-accent text-accent-foreground px-8 py-4 rounded-2xl font-bold text-sm shadow-elevation-2 hover:shadow-elevation-4 transition-all hover:-translate-y-1 active:scale-[0.98] flex items-center justify-center gap-2 group"
 >
 ...
 <h3 className="text-xl font-bold uppercase tracking-tight">Preview</h3>
 ...
 className="flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl text-sm font-bold font-medium hover:bg-primary/90 transition-all"
 >
