...
const InvoiceCard = ({
 ...
 />
 <div>
 <h3 className="text-base font-semibold text-foreground data-text">{invoice.invoice_number}</h3>
 ...
 <span className="text-[10px] font-bold text-muted-foreground font-medium bg-muted px-2 py-0.5 rounded">
 {invoice.invoice_number}
 </span>
 <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-tight ${getStatusColor(invoice.status)}`}>
 {invoice.status}
 </span>
 </div>
 <h3 className="text-base font-bold text-foreground truncate uppercase tracking-tight">
 ...
 <div>
 <p className="text-[10px] font-bold text-muted-foreground font-medium mb-1">Amount</p>
 <p className="text-xl font-bold text-foreground tabular-nums">
 {new Intl.NumberFormat('en-US', { style: 'currency', currency: invoice.currency || 'KES' }).format(invoice.total_amount)}
 </p>
 </div>
 <div className="text-right">
 <p className="text-[10px] font-bold text-muted-foreground font-medium mb-1">
 ...
 className="flex items-center gap-2 text-[10px] font-bold text-primary font-medium hover:underline"
 >
 ...
 <span className="text-[10px] font-bold text-muted-foreground font-medium">Issue Date</span>
 <span className="text-xs font-bold text-foreground">{new Date(invoice.issue_date).toLocaleDateString()}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-[10px] font-bold text-muted-foreground font-medium">
