  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        className="w-full pl-16 pr-14 py-6 bg-card border border-divider rounded-3xl text-xl font-black text-foreground placeholder:text-muted-foreground/30 focus:outline-none focus:ring-8 focus:ring-primary/5 focus:border-primary/30 transition-all shadow-elevation-1 group-hover:shadow-elevation-2"
      />
      {searchQuery && (
        <button
          onClick={handleClear}
