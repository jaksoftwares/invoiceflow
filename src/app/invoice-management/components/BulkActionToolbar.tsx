...
const BulkActionToolbar = ({
 ...
 <p className="text-[10px] font-bold font-medium text-muted-foreground">Selection Active</p>
 <p className="text-xs font-bold uppercase tracking-tight">Records Managed</p>
 </div>
 </div>
 ...
 <button
 onClick={onMarkPaid}
 className="flex items-center gap-2 px-5 py-3 bg-success text-success-foreground rounded-2xl text-xs font-bold font-medium transition-all hover:scale-105 active:scale-95 whitespace-nowrap"
 >
 ...
 className="flex items-center gap-2 px-5 py-3 bg-primary text-white rounded-2xl text-xs font-bold font-medium transition-all hover:scale-105 active:scale-95 whitespace-nowrap"
 >
