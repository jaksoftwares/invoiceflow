...
const RevenueChart = ({ data, currency = 'USD' }: RevenueChartProps) => {
 ...
 <h2 className="text-xl font-semibold text-foreground mb-6">Monthly Revenue Trend</h2>
 ...
 // Format the period for display (e.g., "2026-07" -> "Jul 2026")
 ...
 <h2 className="text-xl font-bold text-foreground tracking-tight">Revenue Analytics</h2>
 <div className="flex items-center gap-2">
 <span className="flex items-center gap-1 text-[10px] font-bold text-muted-foreground font-medium bg-muted/30 px-2 py-1 rounded-md">
 ...
 <div className="h-80 w-full" aria-label="Monthly Revenue Area Chart">
