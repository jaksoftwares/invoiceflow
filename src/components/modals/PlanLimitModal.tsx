...
export default function PlanLimitModal({ 
 ...
 <div>
 <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Verifying Payment</h3>
 ...
 className="text-xs font-bold text-slate-400 font-medium hover:text-primary transition-colors"
 >
 Cancel Waiting
 </button>
 </div>
 ...
 <h2 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight leading-tight mb-2">
 Usage Limit Reached
 </h2>
 ...
 <div>
 <p className="font-bold tracking-tight">Upgrade Plan</p>
 <p className="text-xs text-white/70 font-bold font-medium">Starting from KES 499</p>
 </div>
 </div>
 ...
 <div>
 <p className="font-bold text-slate-900 dark:text-white tracking-tight">One-time Access</p>
 <p className="text-xs text-slate-500 font-bold tracking-widest uppercase">KES {info.paygPrice} via M-Pesa</p>
 </div>
 </div>
 <span className="text-xs font-bold bg-white dark:bg-slate-900 px-3 py-1.5 rounded-full border border-slate-200 border-dashed">PAYG</span>
 </div>
 ...
 className="w-full py-4 bg-slate-900 dark:bg-white dark:text-slate-900 text-white rounded-2xl font-bold text-sm hover:shadow-lg disabled:opacity-50 transition-all flex items-center justify-center gap-2"
 >
 {isProcessing ? (
 <>
 ...
 <p className="text-xs font-bold text-slate-400 font-medium mb-1">Coming Soon</p>
 <p className="text-sm font-bold text-slate-900 dark:text-white opacity-50">Pay-As-You-Go is only for Pro Plans</p>
 </div>
 )}
 </div>
 </div>
 ...
 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Secure Checkout Powered by M-Pesa</p>
 </div>
 </div>
 </div>
 );
